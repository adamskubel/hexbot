...
static const uint32_t BitsIoLdd1_PIN_MASK_MAP[6U] = {
   0x20U, 0x40U, 0x80U, 0x0100U, 0x0200U, 0x0400U
...
LDD_TDeviceData* BitsIoLdd1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOC_PDDR: PDD|=0x07E0 */
  GPIOC_PDDR |= GPIO_PDDR_PDD(0x07E0);
  /* Set initialization value */
  /* GPIOC_PDOR: PDO&=~0x0120,PDO|=0x06C0 */
  GPIOC_PDOR = (uint32_t)((GPIOC_PDOR & (uint32_t)~(uint32_t)(
                GPIO_PDOR_PDO(0x0120)
               )) | (uint32_t)(
                GPIO_PDOR_PDO(0x06C0)
               ));
