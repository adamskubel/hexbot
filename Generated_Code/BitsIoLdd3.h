...
#define BitsIoLdd3_GetDir_METHOD_ENABLED /*!< GetDir method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_SetDir_METHOD_ENABLED /*!< SetDir method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_GetVal_METHOD_ENABLED /*!< GetVal method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_PutVal_METHOD_ENABLED /*!< PutVal method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_GetBit_METHOD_ENABLED /*!< GetBit method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_PutBit_METHOD_ENABLED /*!< PutBit method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_SetBit_METHOD_ENABLED /*!< SetBit method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_ClrBit_METHOD_ENABLED /*!< ClrBit method of the component BitsIoLdd3 is enabled (generated) */
#define BitsIoLdd3_NegBit_METHOD_ENABLED /*!< NegBit method of the component BitsIoLdd3 is enabled (generated) */

/* Definition of implementation constants */
#define BitsIoLdd3_MODULE_BASE_ADDRESS PTB_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORTCONTROL_BASE_ADDRESS PORTB_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORT_MASK 0x000C0000U /*!< Mask of the allocated pin from the port */
#define BitsIoLdd3_PORT_VALID_VALUE_MASK 0x03 /*!< Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
#define BitsIoLdd3_PIN_ALLOC_0_MASK 0x00040000 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd3_PIN_ALLOC_0_INDEX 18U /*!< The index of the first allocated pin from the port */
