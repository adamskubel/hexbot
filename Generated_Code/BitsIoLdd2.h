...
#define BitsIoLdd2_PRPH_BASE_ADDRESS  0x400FF0C0U
...
#define BitsIoLdd2_MODULE_BASE_ADDRESS PTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd2_PORTCONTROL_BASE_ADDRESS PORTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd2_PORT_MASK 0x30U     /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd2_PIN_ALLOC_0_MASK 0x10 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd2_PIN_ALLOC_0_INDEX 4U /*!< The index of the first allocated pin from the port */
